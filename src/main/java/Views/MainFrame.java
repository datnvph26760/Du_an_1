...
public class MainFrame extends javax.swing.JFrame {
    ...
    void loadhome() {
        ...
        try {
            img = ImageIO.read(new File("C:\\Users\\trxua\\Downloads\\ASMDA1\\ASMDA1\\logos", "hinh-cafe-kem-banh-quy.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void lblNhanVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblNhanVienMouseClicked
        ...
        if (ShareHelper.USER.getCv().getMaCV().equalsIgnoreCase("CV01")) {
            QLNhanVien thongtin = new QLNhanVien();
